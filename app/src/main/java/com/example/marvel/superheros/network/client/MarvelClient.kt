package com.example.marvel.superheros.network.client

import com.example.marvel.superheros.commons.Constants
import com.example.marvel.superheros.commons.DomainAPI
...
import com.example.marvel.superheros.network.api.MarvelApi
    ...
    private fun getOkHttpClient() = OkHttpClient().newBuilder()
            .addInterceptor { chain ->
                ...
                val newUrl = chain.request().url()
                        ...
                        .addQueryParameter(
                                "hash",
                                toMD5Hash(currentTimestamp.toString() + Constants.MARVEL_PRIVATE_KEY + Constants.MARVEL_PUBLIC_KEY)
                        )
                        .build()
